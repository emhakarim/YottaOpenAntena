...
| **Y-4** | Nilai emas benchmark kedua: **microstrip line** (ε_eff Hammerstad, Z0 Wheeler/Hammerstad) di `docs/benchmarks.md` + verifikasi implementasi | P2 | Menjawab kelemahan "hanya satu jenis geometri" (masukan Gemini) | rumus + angka + toleransi + sumber; bila paket perlu model saluran, ajukan ke Aksara | belum |
